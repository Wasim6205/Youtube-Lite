...
const Sidebar = () => {
  ...
  return (
    <>
      <div className={`${mobileShow ? "fixed top-0 bottom-0 left-0 transition-all duration-300 bg-white z-40 h-screen w-[50%] sm:w-[30%]" : "hidden h-[calc(100vh-6.625rem)] w-[18%]"} xl:static xl:block px-2 w-[45%] lg:px-6 overflow-y-scroll overflow-x-hidden scrollbar-thin scrollbar-none`}>
